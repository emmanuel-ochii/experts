...
<head>
    ...
    <!-- Page Title  -->
    <title>Forgot Password Success | Expert Invests</title>
    <!-- StyleSheets  -->
                ...
                <div class="nk-block nk-block-middle nk-auth-body">
                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-content">
                            <h5 class="nk-block-title">Dear #name#,</h5>
                            <div class="nk-block-des text-success">
                                <p>click on this link or copy to browser: <a href="reset.php?email=#email#&reset_token=#authToken#">reset.php?email=#email#&reset_token=#authToken#</a></p>
                            </div>
                        </div>
                    </div>
                </div><!-- .nk-block -->
