...
<head>
    ...
    <meta charset="utf-8">
    <meta name="author" content="ExpertInvests">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="@@page-discription">
    <!-- Fav Icon  -->
    <link rel="shortcut icon" href="./images/favico.png">
    <!-- Page Title  -->
    <title>Forgot Password | Expert Invests</title>
    <!-- StyleSheets  -->
            ...
            <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container w-lg-45">
                ...
                <div class="nk-block nk-block-middle nk-auth-body">
                    ...
                    if (isset($_GET['email']) && isset($_GET['reset_token'])) {
                        ...
                        $response = verify_reset($email, $reset_token);
                        if ($response === true) {
                            
                            if (isset($_POST['submit'])) {
                                $response = reset_newpassword($_POST, $email);
                                if ($response === true) {
                                    Redirect("'Location: 1 authSuccess.php");
                                } else{
                                    $errors = $response;
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control form-control-lg" id="password" name="password" placeholder="Enter your password address">
                        </div>
                        <div class="form-group">
                            <div class="form-label-group">
                                <label class="form-label" for="re-password">re-password</label>
                            </div>
                            <input type="re-password" class="form-control form-control-lg" id="re-password" name="re-password" placeholder="Enter your re-password address">
                        </div>
                        <div class="form-group">
                    ...
                    <!-- <div class="form-note-s2 pt-5">
                        <a href="index.php"><strong>Return to login</strong></a>
                    </div> -->
                </div><!-- .nk-block -->
